...
const CONFIG = {
  ...
  resume: {
    fileUrl:
      'https://docs.google.com/document/d/1bENtTYQm-5xARfKO4Lh1YmuVtr6yPqgot0_UxnE-s8s/edit?usp=sharing', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
   'Python',
   'Machine Learning',
  ...
  educations: [
    {
      ...
      degree: 'Master of Science - MS, Computer Science, Specialization in Machine Learning',
      from: '2018',
      to: '2021',
    },
    {
  ...
  googleAnalytics: {
    id: 'UA-150437157-1', // GA3 tracking id/GA4 tag id UA-XXXXXXXXX-X | G-XXXXXXXXXX
  },
